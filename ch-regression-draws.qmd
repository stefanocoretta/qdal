...
In the three-dimensional landscape of a mean and a standard deviation (for a Gaussian model), each draw therefore contains one mean value and one standard deviation value sampled together from the joint posterior distribution.
