...
You have encountered the pipe in @sec-summarise already. You can of course stack multiple functions in the pipeline, like for example filtering the data before plotting it, like so:
