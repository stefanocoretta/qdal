...
Figure out the coding table for the levels of `phonation` like we did in @sec-regression-index for `IsWord`.
:::
...
```{r}
#| label: fig-vot-bm-i
#| fig-cap: "Predicted VOT by consonant phonation in Mixean Basque based on `vot_bm_i`."
