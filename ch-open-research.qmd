...
A commonly used service was the Open Science Framework (OSF): <https://osf.io/>.
As of November 16 2026, OSF will no longer allow the creation of projects, so researchers will have to seek other options (some of which have been already in use).[^ch-open-research-1]
An example of research compendium on OSF, just for illustration purposes, can be found here: <https://osf.io/3bmcp/> [this is the compendium of @coretta2023].
Zenodo (<https://zenodo.org>) is the recommended alternative for depositing research compendia.
An example of compendium on Zenodo can be see at <https://zenodo.org/records/15768992> [this is the compendium of @hampton2024].
This compendium is a GitHub repository (see below on GitHub) which has been linked into a Zotero entry.
There are also other specialised repositories like the Tromsø Repository of Language and Linguistics (TROLLing): <https://dataverse.no/dataverse/trolling>.

[^ch-open-research-1]: If you are interested in knowing why, see <https://www.cos.io/osf-changes> and <https://www.cos.io/blog/osf-changes-a-note-to-users>.
...
GitHub repositories can be linked into Zenodo entries thanks to the GitHub/Zenodo integration, making version control and sharing of research compendia seamless.
