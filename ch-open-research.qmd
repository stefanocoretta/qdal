...
These, combined with theoretical underspecification typical of most research [@devezer2021; @scheel2022], have contributed towards what we can call a "research crisis" [@pashler2012; @gelman2014a; @schooler2014; @fanelli2017; @amrhein2019; @starns2019; @yarkoni2022].
...
A more involved alternative to pre-registration is a new academic article format: Registered Reports [@chambers2015; @karhulahti2022a; @karhulahti2023; @lakens2024].
@fig-rr shows the entire process of the Registered Report format.
...
git allows you to track changes in files, commit those changes into "snapshots" and also maintaining multiple branches of the same repository.
