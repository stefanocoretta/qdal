...
As mentioned in @sec-freq-bayes, the essense of Bayesian inference is the estimation of posterior probability distributions from prior probability distributions and data. In practical terms, you need prior probability distributions, or **priors** for short, and data.

\[XXX illustration of prior to posterior\]

Priors have to be specified by the researcher. The following section explains how.
