...
However, you can learn about priors of Gaussian models in the Spotlight box at the end of this chapter, but after that you can safely assume that priors are handled by brms for you and you should not worry until after you completed this course.
...
## R note: Writing maths in Quarto
...
::: {.callout-important collapse="true"}
## Spotlight: Choosing priors for Gaussian models
