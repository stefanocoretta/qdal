...
cat("**True or false?**", "\n\n")
cat("a. Statistics is a necessary if one wants to know the truth.", torf(FALSE), "\n\n")
...
opts_3 <- c(
  ...
  "Researcher B. I wanted to know if it is true that languages with morphologically rich grammars are more difficult to learn than isolating languages you speak an isolating language. We tested several measures of learning difficulty in two groups of infants, one learning a morphologically rich language and one learning an isolating language. We found that two measures were significantly higher for the morphologically rich language group than the isolating language group. Hence we have found solid evidence that morphologically rich grammars are more difficult to learn.",
